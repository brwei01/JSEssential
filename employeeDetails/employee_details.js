const employees = [
    {id: 1, name: 'John Doe', age: 30, department:'IT', salary: 50000, speicalization: 'JavaScript'},
    {id: 2, name: 'Alice Smith', age: 28, department:'HR', salary: 45000, specialization: 'Python'},
    {id: 3, name: 'Bob Johnson', age: 35, department:'Finance', salary:60000, specialization: 'Java'},
    {id: 4, name: 'J Wong', age: 25, department:'UI', salary: 50000, speicalization: 'JavaScript'},
];
...
function findBySpecJS() {
    ...
    const foundEmployeeDisplay = foundEmployee.map(foundEmployee => `<p>${foundEmployee.id}: ${foundEmployee.name} - ${foundEmployee.department} - $${foundEmployee.specialization}</p>`).join('');
    if (foundEmployee) {
